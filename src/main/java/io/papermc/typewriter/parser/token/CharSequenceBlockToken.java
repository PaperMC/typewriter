...
public record CharSequenceBlockToken(TokenType type, List<String> value, int row, int endRow, int column, int endColumn, int pos, int endPos) implements PrintableToken {
